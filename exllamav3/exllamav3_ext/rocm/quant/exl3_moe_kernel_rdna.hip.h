...
// (v1.5.0 sync applied as upstream's own diff: count_lo / count_hi tiering, the
// deterministic output_scratch path, and the M_TILE template parameter. Only
// M_TILE == 16 is instantiated on RDNA; the 32 / 64-row branches are discarded
